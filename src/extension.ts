...
import {
  MXDefinitionProvider,
  MXInnerDefinitionProvider,
  HtmlDefinitionProvider,
} from "./provider/VSDefinitionProvider";
    ...
    .then(() => {
      ...
      subscriptions.push(
        vscode.languages.registerCompletionItemProvider(
          HTML_MODE,
          new MXEventCompletionItemProvider(),
          "=",
          "'",
          '"'
        )
      ...
      subscriptions.push(
        vscode.languages.registerCompletionItemProvider(
          HTML_MODE,
          new IconfontCompletionItemProvider(),
          "&"
        )
      );
      subscriptions.push(
      ...
      subscriptions.push(
        vscode.languages.registerHoverProvider(
          JTS_HTML_MODE,
          new IconfontHoverProvider()
        )
      );
      subscriptions.push(
        vscode.languages.registerHoverProvider(JTS_MODE, new RapHoverProvider())
      );
      subscriptions.push(
        vscode.languages.registerHoverProvider(
          HTML_MODE,
          new GalleryHoverProvider()
        )
      );
      subscriptions.push(
        vscode.languages.registerHoverProvider(
